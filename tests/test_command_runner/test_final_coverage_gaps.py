...
from cmdorc.command_runner import CommandRunner, CommandConfig, CommandStatus, RunState
...
async def test_get_result_unknown_command():
    ...
    runner = CommandRunner([
        CommandConfig(name="Known", command="echo ok", triggers=["go"])
    ])
...
async def test_has_trigger_with_callbacks_only():
    ...
    runner = CommandRunner([
        CommandConfig(name="Dummy", command="echo ok", triggers=["other"])
    ])
